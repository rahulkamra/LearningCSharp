...
namespace Chapter9
{
    public class ClassA
    {
        ...
        public void addCallBack(TestCallBack test)
        {
            ...
            EventDispatcher<string> eventDispatcher = new EventDispatcher();
            eventDispatcher.AddListeners += onTestEvent;

            eventDispatcher.dispatchEventWith<string>("helloEvent");
        }
        ...
        */
        ...
        public void addPredicate(Predicate<string> predicateCallBack, string toCompare)
        {
            Debug.Log("Is Equal To X " + predicateCallBack(toCompare));
        }
    }
}
