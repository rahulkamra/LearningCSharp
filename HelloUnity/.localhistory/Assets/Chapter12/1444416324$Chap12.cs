...
namespace Chapter12
{
    class Chap12
    {
        ...
        public void execute()   
        {
            ...
            MyAttrib my = typeof(ClassB).GetCustomAttributes(typeof(MyAttrib), true) as MyAttrib;

            MyAttrib my = (MyAttrib)Attribute.GetCustomAttribute(typeof(ClassB), typeof(MyAttrib));
            Debug.Log(my.name);
        }
